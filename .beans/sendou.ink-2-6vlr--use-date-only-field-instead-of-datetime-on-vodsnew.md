...
updated_at: 2026-01-14T19:16:54Z
---
...
## Checklist
- [x] Add `dateRequired` and/or `dateOptional` helpers to fields.ts (if not exists)
- [x] Update vods-schemas.ts to use date field instead of datetime
- [x] Verify form renders date-only picker

...
updated_at: 2026-01-17T15:16:46Z
---
...
## Checklist
- [x] Move the transform logic to the vods action
- [x] Simplify vodFormSchemaServer to just validate
- [x] Ensure the action handles the data transformation
- [x] Create dayMonthYearRequired form field to output date in correct format
- [x] Update SendouForm to use z.input for defaultValues type
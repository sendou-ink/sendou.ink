...
import type { PeakXP, XRankPlacementRegion } from "#lib/db/tables-json.ts";
import { actorId, actorIdOrNull } from "#lib/features/auth/user.server.ts";
import { cachedFullUserLeaderboard } from "#lib/features/leaderboards/leaderboards-core.server.ts";
import { LFG } from "#lib/features/lfg/lfg-constants.ts";
import { TIERS } from "#lib/features/mmr/mmr-constants.ts";
import * as Seasons from "#lib/features/mmr/Seasons.ts";
import type { TieredSkill } from "#lib/features/mmr/tiered.server.ts";
import { userSkills } from "#lib/features/mmr/tiered.server.ts";
import type { CustomTheme } from "#lib/features/theme/theme-types.ts";
import { PRESET_COLORS } from "#lib/features/tier-list-maker/tier-list-maker-constants.ts";
import { LRUCache } from "#lib/server/cache.ts";
...
import type {
	...
	UserCardStat,
	UserCardStatXPValue,
} from "./user-card-types.ts";
import { isValidUnverifiedXp } from "./user-card-utils.ts";

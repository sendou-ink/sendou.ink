...
export const ZONES_WEEKLY_38 = (): TournamentData => ({
	...
	ctx: {
		...
		participatedUsers: [
			45, 1843, 2072, 2899, 3147, 5662, 6114, 10757, 11484, 11780, 13370, 13590, 17855, 21689,
			26992, 30176, 31148, 33047, 33491, 33578, 33611, 37632, 37901, 43518, 43662, 45879, 46006,
			46467, 46813
		],
		logoSrc:

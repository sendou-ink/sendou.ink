...
export const PADDLING_POOL_257 = () =>
	({
		...
		ctx: {
			...
			participatedUsers: [
				76, 185, 193, 223, 271, 343, 368, 379, 1300, 1447, 1624, 2137, 2302, 2622, 2781, 3161, 3929,
				3930, 4603, 5229, 5368, 5528, 5728, 5735, 5740, 6053, 6508, 6870, 6935, 7007, 7094, 7265,
				7270, 7336, 7440, 8139, 8157, 8243, 8258, 8480, 8715, 8734, 8868, 9125, 9211, 9307, 9367,
				9403, 9411, 9874, 9925, 10010, 10293, 10370, 10615, 10883, 10992, 11017, 11056, 11151,
				11199, 11226, 11625, 11627, 11635, 11716, 12188, 12214, 12526, 12976, 13227, 13562, 14489,
				15526, 15916, 17734, 18039, 18143, 18703, 18734, 19002, 19035, 19231, 20063, 20143, 20698,
				20755, 21583, 21698, 21979, 22434, 22452, 22661, 22746, 22948, 23009, 23016, 23037, 23307,
				23353, 23505, 23746, 23820, 23858, 24441, 24585, 24705, 25088, 25545, 26454, 26665, 26758,
				27108, 27468, 27515, 27578, 27664, 27686, 27768, 27958, 28178, 28191, 28194, 28271, 28338,
				28482, 28485, 28602, 28629, 28822, 28834, 28851, 29321, 29723, 29904, 30220, 30449, 30582,
				30730, 30758, 30928, 30942, 31658, 32155, 32688, 34238, 34715, 35118, 35382, 35807, 37658,
				38062, 38120
			]
		}
	}) as TournamentData;
...
export const PADDLING_POOL_255 = () =>
	({
		...
		ctx: {
			...
			participatedUsers: [
				62, 115, 205, 222, 306, 331, 342, 418, 461, 1447, 1740, 2137, 2302, 2392, 2414, 2589, 2670,
				3060, 3161, 3400, 3929, 3930, 4061, 4234, 4275, 4606, 4807, 5072, 5368, 5528, 5844, 6202,
				6508, 6710, 6870, 6935, 7007, 7094, 7440, 7735, 8169, 8243, 8391, 8715, 8868, 9125, 9211,
				9342, 9535, 9547, 9719, 9874, 10578, 10615, 10812, 10819, 10883, 10992, 11017, 11151, 11506,
				11517, 11593, 11625, 11627, 12351, 12358, 12526, 12619, 12642, 12976, 13296, 13562, 13736,
				13832, 13997, 14489, 14927, 14973, 15135, 15326, 15346, 15526, 15880, 16634, 17137, 17940,
				18290, 18703, 18734, 18969, 19002, 20755, 21979, 21989, 22434, 22452, 22661, 22746, 22948,
				23128, 23307, 23746, 23784, 23858, 24441, 24585, 25242, 25400, 25814, 25954, 26392, 26665,
				26683, 26726, 26792, 27108, 27515, 27578, 27664, 27686, 27958, 27960, 28441, 28485, 28629,
				28662, 28725, 28745, 28822, 28851, 29099, 29321, 29433, 29904, 30220, 30234, 30449, 30582,
				30751, 30972, 31131, 31311, 31358, 31597, 31690, 32156, 32328, 32579, 32688, 34933, 35118,
				35807, 38062, 38080, 38902
			]
		}
	}) as TournamentData;
...
export const IN_THE_ZONE_32 = ({ undergroundRequiresCheckIn = true, hasCheckedOutTeam = false }) =>
	({
		data: {
			stage: [
				{
					...
					settings: {
						grandFinal: 'double',
						size: 32,
						seedOrdering: ['space_between', 'natural', 'reverse', 'half_shift', 'natural']
					},
					tournament_id: 11,
		...
		ctx: {
			...
			tieBreakerMapPool: [],
			participatedUsers: [
				8, 18, 32, 35, 36, 41, 48, 50, 57, 70, 76, 81, 94, 100, 104, 112, 115, 118, 123, 124, 126,
				133, 138, 141, 145, 147, 151, 164, 168, 172, 185, 202, 206, 211, 229, 232, 233, 236, 246,
				249, 252, 255, 257, 260, 272, 286, 291, 292, 305, 319, 321, 335, 346, 372, 392, 405, 411,
				439, 451, 702, 957, 1038, 1043, 1117, 1136, 1178, 1300, 1441, 1658, 2414, 2801, 3258, 3298,
				4061, 4099, 4307, 4603, 5337, 5728, 6255, 6307, 6557, 6710, 7326, 8734, 9064, 9125, 9367,
				9674, 9718, 10192, 10200, 10293, 10592, 10812, 11010, 11148, 11467, 11517, 11593, 12395,
				12976, 13296, 13342, 13614, 14489, 14605, 15346, 15403, 15418, 15916, 16980, 18039, 18734,
				20143, 20154, 20583, 20731, 20859, 21339, 22041, 22344, 22893, 22948, 23128, 23381, 23820,
				24705, 25400, 25423, 26392, 27108, 27958, 28191, 28482, 28725, 28851, 34238, 35807, 37105,
				38080
			]
		}
	}) as TournamentData;

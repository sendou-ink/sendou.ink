import type { DAMAGE_TYPE } from '$lib/constants/analyzer';
import type {
	Ability,
	AbilityWithUnknown,
	MainWeaponId,
...
import type { abilityValues } from './utils';
import type { weaponParams } from './weapon-params';

type Overwrites = Record<string, Partial<Record<'High' | 'Mid' | 'Low', number>>>;

import { abilities, mainOnlyAbilitiesShort } from '$lib/constants/in-game/abilities';
import type { Ability, BuildAbilitiesTuple } from '$lib/constants/in-game/types';
...
export function sortAbilities(abilities: BuildAbilitiesTuple): BuildAbilitiesTuple {
	...
	const newMainAbilities = oldMainAbilities.map((ability) =>
		mainOnlyAbilitiesSet.has(ability as any) ? ability : sortedMainAbilities.pop()
	);
...
function switchSubRowsIfBetter(abilities: BuildAbilitiesTuple): BuildAbilitiesTuple {

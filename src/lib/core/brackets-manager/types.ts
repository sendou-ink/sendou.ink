import type { Group, Match, Round, SeedOrdering, Stage } from '$lib/core/brackets-model';
...
export interface CrudInterface {
	 ...
	 */
	select<T extends Table>(table: T, filter: Partial<DataTypes[T]>): Array<DataTypes[T]> | null;
...
export interface Storage extends CrudInterface {
	selectFirst<T extends Table>(table: T, filter: Partial<DataTypes[T]>): DataTypes[T] | null;
	selectLast<T extends Table>(table: T, filter: Partial<DataTypes[T]>): DataTypes[T] | null;
}

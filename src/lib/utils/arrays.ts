...
export function normalizeFormFieldArray(value: undefined | null | string | string[]): string[] {
...
export function removeDuplicatesByProperty<T>(arr: T[], getter: (arg0: T) => number | string): T[] {
	const seen = new Set();
	return arr.filter((item) => {

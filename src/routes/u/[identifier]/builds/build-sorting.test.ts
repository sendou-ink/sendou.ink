...
describe('sortBuilds()', () => {
	it('sorts by UPDATED_AT', () => {
		const builds = [
			mockBuild({ id: 1, updatedAt: new Date(1) }),
			mockBuild({ id: 2, updatedAt: new Date(3) }),
			mockBuild({ id: 3, updatedAt: new Date(2) })
		];
	...
	it('sorts by UPDATED_AT and ALPHABETICAL_TITLE', () => {
		const builds = [
			mockBuild({ id: 1, updatedAt: new Date(3), title: 'C' }),
			mockBuild({ id: 2, updatedAt: new Date(2), title: 'B' }),
			mockBuild({ id: 3, updatedAt: new Date(2), title: 'A' })
		];

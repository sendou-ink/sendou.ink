...
} from "~/features/front-page/front-page-queries";
...
export const Route = createFileRoute("/")({
	beforeLoad: async () => {
		await i18next.loadNamespaces(["front", "common", "game-misc"]);
	},
	loader: ({ context }) =>
		context.queryClient.ensureQueryData(frontPageQueryOptions()),
	component: FrontPage,
});
...
function SeasonBanner() {
	...
	return (
		<div className={styles.seasonBannerMobileOnly}>
			<Link to="/q" className={styles.seasonBanner}>
			...
			<Link to="/q" className={styles.seasonBannerLink}>
